  ...
  return (
    <div className={styles.loginPage}>
      ...
      <div className={styles.loginBg}>
        ...
        <div className={`${styles.loginOrb} ${styles.loginOrb3}`} />
      </div>
      ...
      <div className={styles.loginCard}>
        ...
        <div className={styles.loginHeader}>
          ...
          <p className={styles.loginSubtitle}>
            Sign in to access your personal data dashboard
          </p>
        </div>
      ...
      {/* Bottom note */}
      <p className={styles.loginPageNote}>
        Protected by end-to-end encryption · Zero-knowledge architecture
      </p>
    </div>
  );
};
